...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "BoxesGameVersion2.py"

        #Name of program
        self.project_name = "BoxesGameVersion2"
    ...
    def run(self):
        ...
        setup(
            ...
            options = {'py2exe': {'optimize': 2, 'bundle_files': 1, 'compressed': True, \
                                  'excludes': ["OpenGL.GL", "Numeric", "copyreg", "itertools.imap", "numpy", "pkg_resources", "queue", "winreg", "pygame.SRCALPHA", "pygame.sdlmain_osx","AppKit", "Foundation", "PIL", "_scproxy", "_sysconfigdata", "dummy.Process", "tkinter", "tkinter.filedialog"], 'packages': self.extra_modules, \
